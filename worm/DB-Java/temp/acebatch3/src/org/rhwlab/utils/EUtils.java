...
/**
 * A class to hold static simple utility functions. <br>
 * At this point, the two version of <code>makePaddedInt</code> are the only
 * things in use.
 *
 * @author biowolp
...
public class EUtils {
	...
	static public String makeVersion() {
		...
		String version = String.valueOf(year) + padInt(month) + padInt(day) + padInt(hr) + padInt(min);
		return version;
	...
	/**
	 * create a String representation of int with leading zeros used to padd it to
	 * specified width
	 * 
	 * @param k     int to be converted to string form
