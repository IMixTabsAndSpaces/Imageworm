...
public class HeatMap extends Canvas {
	...
	private int getDiscrete(int r) {
		int k = 0;
		k = (int) ((r - iMin) * iScale);
		// System.out.println("getDiscrete: " + k + ", " + r + ", " + iMin + ", " +
		// iScale);
	...
	public void paint(Graphics g) {
		...
		for (int j = 0; j < iNumCells; j++) {
			...
			for (int i = 0; i < iNumTimes; i++) {
				...
				// System.out.println("paint: " + j + ", " + i + ", " + iR[j][i] + ", " +
				// discrete);
	...
	private static final Color[] CMAP = { new Color(000, 255, 0), new Color(000, 230, 0), new Color(000, 205, 0),
