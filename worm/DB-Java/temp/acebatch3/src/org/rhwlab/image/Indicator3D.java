...
public class Indicator3D extends JPanel {
	...
	public Indicator3D() {
		...
		/*
		 * Transform3D t3d = new Transform3D(); iTranslateGroup.getTransform(t3d);
		 * Matrix4d m4d = new Matrix4d(); t3d.get(m4d); println("m4d, " + m4d);
		 * println("t3d, " + t3d); m4d.m23 = .554; t3d.set(m4d);
	...
	public class Talisman {
		public Talisman() {
			...
			// iBGT.addChild(makeNamedSphere("bogus", z, z, 1.845f, d,
