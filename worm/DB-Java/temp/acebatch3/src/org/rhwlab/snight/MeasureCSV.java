...
public class MeasureCSV {
	...
	public void writeCSV(String filePath) {
		...
		/*
		 * int k = filePath.lastIndexOf("/"); String s = ""; String series =
		 * (String)iMeasureHash.get(att[SERIES]); if (k == filePath.length() - 1) s =
		 * filePath + series; else s = filePath + "/" + series; s += "AuxInfo.csv";
		 * //println("writeCSV: " + s);
		 */
		PrintWriter pw = null;
		try {
	...
	public static String[] att = { "name", "slope", "intercept", "xc", "yc", "maj", "min", "ang", "zc", "zslope",
			"time", "zpixres", "axis"

	};

	// revised 20090701
	public static String[] defaultAtt = { "xxxx", "0.9", "-27", "360", "255", "585", "390", "0", "14", "10.4", "160",
			"11.1", "XXX" };

	public static final int SERIES = 0, TSLOPE = 1, TINTERCEPT = 2, EXCENTER = 3, EYCENTER = 4, EMAJOR = 5, EMINOR = 6,
			EANG = 7, ZCENTER = 8, ZSLOPE = 9, TIME = 10, ZPIXRES = 11, AXIS = 12;
	...
	public static void main(String[] args) {
		...
		if (g != 2)
			println("MeasureCSV.main, " + g + CS + "questionable AuxInfo");
