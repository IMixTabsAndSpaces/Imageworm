...
public class EllipseViewer extends JDialog implements ActionListener {
	...
	public EllipseViewer() {
		...
		/*
		 * special for series 20090916_nhr57_end3d_3_L2 iTime = 110; iCenter = 14;
		 * iXCenter = 378; iYCenter = 248; iMajor = 521; iMinor = 329; iAngle = 54.8;
		 */
		...
		/*
		 * iXCenter = 384; iYCenter = 270; iMajor = 529; iMinor = 344; iAngle = 38.56;
		 */
		xCenter = iXCenter;
		yCenter = iYCenter;
		major = iMajor;
		...
		showImage();
		/*
		 * JFrame owner = iAceTree.getMainFrame(); JDialog dialog = this; JPanel p = new
		 * JPanel(); p.setLayout(new BoxLayout(p, BoxLayout.PAGE_AXIS));
		 * p.setPreferredSize(new Dimension(200,600)); p.setOpaque(true); //content
		 * panes must be opaque dialog.setContentPane(p); dialog.pack();
		 * 
