...
/**
 * control panel for selecting a cell by typing the time index and the cell name
 * or index in nuclei file for that time
 * 
...
public class InputCtrl extends JPanel implements ActionListener {
	...
	protected JComponent createEntryFields() {
		...
		String[] labelStrings = { "image time: ", "index/cell name: " };
	...
	final public static int WIDTH = 200, HEIGHT = 100;
