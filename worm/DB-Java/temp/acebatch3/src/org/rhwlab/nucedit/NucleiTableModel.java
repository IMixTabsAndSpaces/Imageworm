...
public class NucleiTableModel extends AbstractTableModel {
	...
	/**
	 * fill in table from nucleus specified by its index position in the NucleiMgr
	 * object
	 * 
	 * @param nucleiMgr
	 * @param index
	...
	public final static String[] colnames = { "identity", "index", "status", "pred", "succ1", "succ2", "x", "y", "z",
			"size", "weight", "rweight" };

	/*
	 * public final static String [] colnames = { "index" ,"x" ,"y" ,"z" ,"identity"
	 * ,"size" ,"weight" ,"status" ,"spong1" ,"spong2" ,"piecer" ,"piecer2" ,"pred"
	 * ,"succ1" ,"succ2" };
	 */
	/*
	 * (non-Javadoc)
	...
	public int getColumnCount() {
		...
		if (o == null)
			...
			return ((Vector) iVdata.elementAt(0)).size();
	}
	...
	/**
	 * adds row to the table and initializes everything to a safe default
	 *
	 */
	public void addRow() {
		Vector row = new Vector();
	...
	/**
	 * access function for the time point corresponding to the top spreadsheet
	 * 
	...
	final static public int IDENT = 0, INDEX = 1, STAT = 2, PRED = 3, SUCC1 = 4, SUCC2 = 5, X = 6, Y = 7, Z = 8,
			SIZE = 9, WT = 10;
	/*
	 * final static public int INDEX = 0 ,X = 1 ,Y = 2 ,Z = 3 ,IDENT = 4 ,SIZE = 5
	 * ,WT = 6 ,STAT = 7 ,SPONG1 = 8 ,SPONG2 = 9 ,PR1 = 10 ,PR2 = 11 ,PRED = 12
	 * ,SUCC1 = 13 ,SUCC2 = 14 ;
	 */

	final static public String ADD = "ADD";
