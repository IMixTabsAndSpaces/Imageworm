 ...
 * @author biowolp
 *
 *         ADD SERIES DIALOG Window - Preferences - Java - Code Style - Code
 *         Templates
 */
public class EIDialog1 extends JDialog implements ActionListener, WindowFocusListener {
	...
	// mouse events are trapped in editImage3 and passed into this fn if its window
	// if is up
	...
	protected static final String UP = "UP", DOWN = "DOWN", LEFT = "LEFT", RIGHT = "RIGHT", TEST = "TEST",
			UNDO = "UNDO", BIG = "BIG", SMALL = "SMALL", ADD = "addCell", REBUILDANDRENAME = "rebuildAndRename";
