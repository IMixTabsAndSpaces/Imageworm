...
public class Image3D2Z extends MouseAdapter implements ActionListener, Runnable, DocHandler {
	...
	public class Nuclei3D {
		...
		private void reportAngle(int time, String name1, String name2, double x1, double y1, double z1, double x2,
				double y2, double z2) {
			// println("reportAngle, " + name1 + CS + name2 + CS + x1 + CS + y1 + CS + z1 +
			// CS + x2 + CS + y2 + CS + z2);
	...
	public Image3D2Z(AceTree aceTree, String title) {
		...
		/*
		 * t3d.get(m4d); println("m4d, " + m4d); println("t3d, " + t3d); m4d.m23 = .554;
		 * // near center of SimpleUniverse t3d.set(m4d);
		...
		if (dispProps == null)
			iAceTree.setDispProps3D2Z((Object) getDisplayProps());
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o == iXUp || o == iXDn || o == iYUp || o == iYDn || o == iZUp || o == iZDn || o == iPIn || o == iPOut
	...
	public class PropertiesTab3 implements ActionListener {
		...
		public class SublineageUI {
			...
			public SublineageUI(int i) {
				...
				String[] list;
				list = COLORS;
				if (i == iDispProps2Z.length - 2)
					list = TRANSPROPS;
				else if (i == iDispProps2Z.length - 1)
					list = GRAYDEPTH;
