...
odMFILE "<?xml version='1.0' encoding='utf-8'?>\n";
odMFILE  "<embryo>\n";
od
odMFILE "<image file=\"".$DIRECTORY.$TIFFLOCATION.$FILEROOT."-t001-p01.tif\"/>\n";
odMFILE "<nuclei file=\"".$SERIESDIR ."/dats/".$FILEROOT."-edit.zip\"/>\n";
od
