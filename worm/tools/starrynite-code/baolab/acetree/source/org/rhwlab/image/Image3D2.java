...
public class Image3D2 extends MouseAdapter
	...
	iUniverse.getViewer().getView().setSceneAntialiasingEnable(false);
        ...
        if (dispProps == null) iAceTree.setDispProps3D2( (Object) viewConfig.getDispProps() );
        

        //iPT2 = new PropertiesTab2(this);
        iTabbedPane.addTab("Color Controls", null, iColorControlPanel, "Set color scheme");
    ...
    public void startElement(String tag, Hashtable h) throws Exception {
        if(tag.equals("rotation")) {
            ...
            viewConfig.getDispProp(lineageCount).setLineageNum(
                    Image3DViewConfig.getColorIndex(color));
    ...
    private void saveMovie() {
        ...
        if(!iSaveImage){
            ...
            if(!iAceTree.hasActiveImage3D2()) {
                ...
                String path = iAceTree.iImgWin.getSaveImageDirectory() + "/" + name + ".jpeg";
        ...
        if (command.equals("Cancel Changes")) {
            ...
            if(viewConfig.isOverlayXYZChanged()) {
                if(overlayMinXSlider.getValue() <= overlayMaxXSlider.getValue()) {
                    ...
                    overlayMinXSlider.setValue(viewConfig.DEFAULT_OVERLAY_MIN_X);
                    overlayMaxXSlider.setValue(viewConfig.DEFAULT_OVERLAY_MAX_X);
                }
                ...
                if(overlayMinYSlider.getValue() <= overlayMaxXSlider.getValue()) {
                    ...
                    overlayMinYSlider.setValue(viewConfig.DEFAULT_OVERLAY_MIN_Y);
                    overlayMaxYSlider.setValue(viewConfig.DEFAULT_OVERLAY_MAX_Y);
                }
                ...
                if(overlayMinZSlider.getValue() <= overlayMaxXSlider.getValue()) {
                    ...
                    overlayMinZSlider.setValue(viewConfig.DEFAULT_OVERLAY_MIN_Z);
                    overlayMaxZSlider.setValue(viewConfig.DEFAULT_OVERLAY_MAX_Z);
                }
            }
	...
	//iNuc3D = new Nuclei3D();
        ...
        if(viewConfig.isShowingOverlay()) {
            ...
            //overlayGenerator.notify();
        }

        iNucBG =  geometryManager.createNuclearBranchGroup(iXA, iYA, iZA);
        //if (iNuc3D.empty()) return null;
        if (geometryManager.empty()) return null;
        //iIndicator = new Indicator3D();
        //new Axis();
	//iNuc3D.nucBG.compile();
        iNucBG.compile();
        //objRotate.addChild(iNuc3D.nucBG);
    ...
    // called by AceTree image3D2Save()
    ...
    private void buildColorControlGUI() {
        ...
        for(int i = 0; i < viewConfig.getNumDispProps(); i++) {
            ...
            iSubUI[i] = new SublineageUI(tempDispProp);
        ...
        botPart.setLayout(new BoxLayout(botPart,BoxLayout.PAGE_AXIS));
        ...
        JLabel timePtsLabel = new JLabel("Number of Time Points Tracked", JLabel.CENTER);
        timePtsLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
        timePts = new JSlider(JSlider.HORIZONTAL, viewConfig.MIN_TAIL_TIME_PTS, 
                viewConfig.MAX_TAIL_TIME_PTS, viewConfig.INIT_TAIL_TIME_PTS);
        ...
        */
        ...
        customTailColor.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                viewConfig.setCustomTailColor( JColorChooser.showDialog(iFrame, 
                    "Select a Custom Tail Color", viewConfig.DEFAULT_CUSTOM_TAIL_COLOR) );
            }
        });
        ...
        */
        ...
        JLabel overlayLabel = new JLabel("Overlay Options", JLabel.CENTER);
        ...
        JLabel overlayMinXLabel = new JLabel("Overlay Min X", JLabel.CENTER);
        overlayMinXLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
        overlayMinXSlider = new JSlider(JSlider.HORIZONTAL, 0, 512, viewConfig.DEFAULT_OVERLAY_MIN_X);
        ...
        JLabel overlayMaxXLabel = new JLabel("Overlay Max X", JLabel.CENTER);
        overlayMaxXLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
        overlayMaxXSlider = new JSlider(JSlider.HORIZONTAL, 0, 512, viewConfig.DEFAULT_OVERLAY_MAX_X);
        ...
        JLabel overlayMinYLabel = new JLabel("Overlay Min Y", JLabel.CENTER);
        overlayMinYLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
        overlayMinYSlider = new JSlider(JSlider.HORIZONTAL, 0, 512, viewConfig.DEFAULT_OVERLAY_MIN_Y);
        ...
        JLabel overlayMaxYLabel = new JLabel("Overlay Max Y", JLabel.CENTER);
        overlayMaxYLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
        overlayMaxYSlider = new JSlider(JSlider.HORIZONTAL, 0, 512, viewConfig.DEFAULT_OVERLAY_MAX_Y);
        ...
        JLabel overlayMinZLabel = new JLabel("Overlay Min Z", JLabel.CENTER);
        overlayMinZLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
        overlayMinZSlider = new JSlider(JSlider.HORIZONTAL, 0, 30, viewConfig.DEFAULT_OVERLAY_MIN_Z);
        overlayMinZSlider.addChangeListener(this);
        overlayMinZSlider.setMajorTickSpacing(5);
        overlayMinZSlider.setMinorTickSpacing(1);
        ...
        JLabel overlayMaxZLabel = new JLabel("Overlay Max Z", JLabel.CENTER);
        overlayMaxZLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
        overlayMaxZSlider = new JSlider(JSlider.HORIZONTAL, 0, 30, viewConfig.DEFAULT_OVERLAY_MAX_Z);
        overlayMaxZSlider.addChangeListener(this);
        overlayMaxZSlider.setMajorTickSpacing(5);
        overlayMaxZSlider.setMinorTickSpacing(1);
        ...
        JLabel overlaySubsampleLabel = new JLabel("Subsample size: ", JLabel.CENTER);
        overlaySubsampleSlider = new JSlider(JSlider.HORIZONTAL, 1, 9, viewConfig.DEFAULT_OVERLAY_SUBSAMPLE);
    ...
    private void loadFromFile() {
        ...
        for (int i = 0; i < viewConfig.getNumDispProps() - 2; i++) {
            viewConfig.getDispProp(i).setName(" ");
            viewConfig.getDispProp(i).setLineageNum(0);
        }
        update();
