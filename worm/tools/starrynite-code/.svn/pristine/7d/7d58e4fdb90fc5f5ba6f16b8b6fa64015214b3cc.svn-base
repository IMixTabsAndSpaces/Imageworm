...
namespace starrynite
{
  ...
  void
  movie_ (::std::ostream& os,
          const ::starrynite::movie& x, 
  ...
  void
  movie_ (::xercesc::XMLFormatTarget& ft,
          const ::starrynite::movie& x, 
          const ::xml_schema::namespace_infomap& m,
          const ::std::string& e = "UTF-8",
          ::xml_schema::flags f = 0);
  ...
  movie_ (const ::starrynite::movie& x, 
          const ::xml_schema::namespace_infomap& m,
          ::xml_schema::flags f = 0);
}
