...
public class UnifiedNucRelinkDialog extends NucRelinkDialog{
    ...
    public UnifiedNucRelinkDialog(AceTree aceTree, Frame owner, boolean modal,
    		Cell cell, int time) {
    	super(owner, modal);
    	...
    	JLabel label=new JLabel(KEYFRAMEHEADER,JLabel.CENTER);
    ...
    public void actionPerformed(ActionEvent e) {
    	...
    	if (o==iAddKeyframe){ //cmd.equals(KEYFRAME)) {
    ...
    public void processMouseEvent(MouseEvent e){
    	...
    	if(addKeyframeActive&iWarned.isSelected()){
    		...
    		if(!iStartArmed|strCellName.equals(AceTree.ROOTNAME)){
    			...
    			else{System.out.println("Start: "+startTime+" current "+time+" cannot extend before end of track");
    				return;
    				}
