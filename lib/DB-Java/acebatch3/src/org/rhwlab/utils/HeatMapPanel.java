...
public class HeatMapPanel extends ScrollPane {
	...
	/*
	 * public Dimension getSize() { System.out.println("getPreferredSize"); return
	 * new Dimension(iWidth, iHeight); }
	 * 
	 * public Dimension getPreferredSize() { System.out.println("getPreferredSize");
	 * return new Dimension(iWidth, iHeight); }
	 * 
	 * public Dimension getMinimumSize() { System.out.println("getMinimumSize");
