...
public class AceMenuBar extends JMenuBar implements ActionListener, ItemListener {
	...
	final private static String FILE = "File", QUICKOPEN = "Quick open (no config file needed)",
			OPEN = "Open config file", OPENSERIES = "Open series", CLEARALL = "Clear all", OPTIONS = "Options",
			SAVE = "Save nuclei as zip", SAVECONFIG = "Save config file", EXIT = "Exit",
			EXPORT = "Export newick lineage", ACTION = "Action", BUILDTREE = "Build Tree", REBUILDTREE = "Rebuild Tree",
			CLEAR = "Clear tree", EXPAND = "Expand tree", TEST = "Test", TEST1 = "test1", TREES = "Trees",
			ATVTREE = "Save tree as Newick file", SULSTON = "Ancestral tree", VTREE = "V Ancestral tree",
			CANONICAL = "Sulston tree", SHOW = "Show", NUCLEI = "nuclei", EDIT = "Edit", EDITTOOLS = "Edit tools"

			, SHOWLOG = "Show log", DDLOG = "Div/death log", ANALYZE = "Analyze",
			ANALYSISDEVELOPMENT = "Nuclei rotation", ANALYSIS3 = "Analysis3", ANALYSIS4 = "Identity data",
			ANALYSIS5 = "Analysis5", ANALYSIS6 = "Analysis6", ANALYSIS7 = "Extract red", REDBKGCOMP = "Red Bkg Comp",
			REDCOMPSERIES = "Red Comp Series", ANALYSIS8 = "Analysis8", ANALYSIS9 = "Red expression",
			ANALYSIS10 = "Imaging test", EDITTRAVERSE = "Edit Traverse", ADJACENCIES = "Deaths/Adjacencies",
			USEPLUGIN = "Use Plugin", DOEDIT = "Edit nuclei", DOEDIT2 = "Edit nuclei test", VIEWNUCLEI = "View nuclei",
			RELINK = "Relink nuclei", SKIPFALSENEGATIVES = "Skip false negatives", KILLCELL = "Kill cell",
			KILLCELLS = "Kill cells", KILLDEEPNUCS = "Kill deep nucs", SETENDTIME = "Set end time",
			INCREMENTENDTIME = "Increment end time", UNDO = "Undo", VIEW = "View", THREED = "3D View",
			THREED2 = "3D2 View", THREED3 = "3D2Z View", THREEDSAVE = "Save 3D", THREEDTWOSAVE = "Save 3D2",
			THREEDTWOZSAVE = "Save 3D2Z", TWODSAVE = "Save 2D", VIEWELLIPSE = "View ellipse",
			DEPTHVIEWS = "Depth views", ALLCENTROIDS = "All Centroids", CELLMOVEMENT = "Cell Movement",
			DEBUGLOG = "Debug Log", HELP = "Help", ABOUT = "About", NEW = "New features"
