...
////////////////////////////////////////////////////////////////////////////////////////////////////    
	private Group createGeometry() {
		...
		Cone cone1 = new Cone(0.05f, 0.1f, Cone.ENABLE_APPEARANCE_MODIFY, 4, 2, appY);
		TG1.addChild(cone1);
		tripod.addChild(TG1);
		...
		Cylinder cyl1 = new Cylinder(0.01f, 0.3f, Cylinder.ENABLE_APPEARANCE_MODIFY, 4, 2, appY);
		TG2.addChild(cyl1);

		// Display axis names
		Font3D f3d = new Font3D(new Font("dialog", Font.PLAIN, 1), new FontExtrusion());
		Text3D text3d = new Text3D(f3d, "Y", new Point3f(0f, 0f, 0f), Text3D.ALIGN_CENTER, Text3D.PATH_RIGHT);
		// fix the 3d text displayed face
		OrientedShape3D orient = new OrientedShape3D(text3d, appY, OrientedShape3D.ROTATE_ABOUT_POINT,
		...
		Cone cone2 = new Cone(0.05f, 0.1f, Cone.ENABLE_APPEARANCE_MODIFY, 4, 2, appX);
		...
		Cylinder cyl2 = new Cylinder(0.01f, 0.3f, Cylinder.GENERATE_NORMALS, 4, 2, appX);

		TG4.addChild(cyl2);

		// Display axis names
		Font3D f3dX = new Font3D(new Font("dialog", Font.PLAIN, 1), new FontExtrusion());
		Text3D text3dX = new Text3D(f3dX, "X", new Point3f(0f, 0f, 0f), Text3D.ALIGN_CENTER, Text3D.PATH_RIGHT);
		// fix the 3d text displayed face
		OrientedShape3D orientX = new OrientedShape3D(text3dX, appX, OrientedShape3D.ROTATE_ABOUT_POINT,
				new Point3f(0f, 0f, 0f));
		...
		Cone cone3 = new Cone(0.05f, 0.1f, Cone.ENABLE_APPEARANCE_MODIFY, 4, 2, appZ);
		TG5.addChild(cone3);
		tripod.addChild(TG5);
		///////////////////////////////////////
		...
		Cylinder cyl3 = new Cylinder(0.01f, 0.3f, Cylinder.ENABLE_APPEARANCE_MODIFY, 4, 2, appZ);
		TG6.addChild(cyl3);

		// Display axis names
		Font3D f3dZ = new Font3D(new Font("dialog", Font.PLAIN, 1), new FontExtrusion());
		Text3D text3dZ = new Text3D(f3dZ, "Z", new Point3f(0f, 0f, 0f), Text3D.ALIGN_CENTER, Text3D.PATH_RIGHT);
		// fix the 3d text displayed face
		OrientedShape3D orientZ = new OrientedShape3D(text3dZ, appZ, OrientedShape3D.ROTATE_ABOUT_POINT,
				new Point3f(0f, 0f, 0f));
		// TG to reduce text size
