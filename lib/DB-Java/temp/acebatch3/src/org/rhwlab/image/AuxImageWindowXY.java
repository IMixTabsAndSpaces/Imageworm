 ...
 * @author biowolp
 *
 *         This version was used to explore handling the DIC image At the moment
 *         (May 1, 2006) it is not in use
 */
public class AuxImageWindowXY extends AuxImageWindowXZ {

	ImageProcessor iGreen;

	public AuxImageWindowXY(String title, ImageProcessor green, ImageProcessor dataProc, AceTree aceTree, int y) {
