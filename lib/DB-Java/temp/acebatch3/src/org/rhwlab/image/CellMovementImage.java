...
public class CellMovementImage extends ImageWindow {
	...
	public ImagePlus refreshDisplay(String imageName) {
		// System.out.println("CellMovementImage2.refreshDisplay called: " + new
		...
		// System.out.println("EditImage.refreshDisplay2: " + iImagePlane + C.CS +
		// iPlaneInc);
		updateCurrentInfo(true);
		// updateTextFields();
		// System.out.println("EditImage.refreshDisplay3: " + iImagePlane + C.CS +
		// iPlaneInc);
		ImagePlus ip = null;
		...
		// iSpecialEffect = null;
		iImgCanvas.repaint();
		// System.out.println("EditImage.refreshDisplay exiting: " + new
		// GregorianCalendar().getTime());
		return iImgPlus;
	}
