...
/**
 * responds to menu commands on the edit dialog and makes the requested changes
 * in the nuclei vector of NucleiMgr <br>
 * holds an array of NucleiTableModel objects which are potentially editable by
 * the user
 * 
 * @author biowolp
...
public class NucEditModel {
	...
	/**
	 * construct a NucEditModel from an AceTree object only the NucleiMgr object of
	 * AceTree is accessed
	 * 
	 * @param nucEdit the AceTree object which is available in the NucEditDialog
	...
	/**
	 * makes changes based on contents of the two spreadsheets of the edit dialog
	 * 
	...
	/**
	 * called from menu action; delegates work to the NucleiTableModel objects
	 * 
