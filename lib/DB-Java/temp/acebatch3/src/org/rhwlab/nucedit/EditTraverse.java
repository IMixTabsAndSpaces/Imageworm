...
public class EditTraverse implements ActionListener, ListSelectionListener {
	...
	private void buildToolBar() {
		...
		if (iRoot != null)
			iRootCell.setText(iRoot.getName());
		else
			iRootCell.setText("ABa");
	...
	private String getTrulySelectedCellName() {
		...
		if (index > 0)
			iCurrentCellName = (String) iListModel.elementAt(index - 1);
		else
			iCurrentCellName = name;
