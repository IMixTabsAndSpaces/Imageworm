...
/**
 * This is the editing dialog called from the Edit menu of AceTree It uses
 * JTable objects to do the substantive work
 * 
 * @author biowolp
...
public final class NucEditDialog extends JDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		/*
		 * if (o == iCommit || o == iFixxButton) { //String time =
		 * (String)iTimeField.getText().trim(); int i = Integer.parseInt(time) - 1;
		 * iNucEditModel.commitAllChanges(i); } else if (o == iAdd1) {
		 * iNucEditModel.getNucleiTableModel(0).addRow(); } else if (o == iAdd2) {
	...
	private final static String TITLE = "Nuclei Viewer", TEST = "Test", TEST1 = "test1", TEST2 = "test2", READ = "Read",
			NEXT = "Next", PREV = "Prev", FIXX = "Fixx", TIME = "Time: ", ADD = "Add", ADD1 = "Add to first time",
			ADD2 = "Add to second time", EDIT = "Edit", COMMIT = "Commit changes", FILE = "File", QUIT = "Quit",
			END = "Exit";
