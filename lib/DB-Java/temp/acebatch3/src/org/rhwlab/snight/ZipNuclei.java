...
/**
 * Instantiated in AncesTree. <br>
 * Opens the zip file holding data and analyses files. <br>
 * Reads data line be line from a selected file in the zip. <br>
 * Holds iZipFile, an instance of java.util.zip.ZipFile and makes it available
...
public class ZipNuclei {
	...
	/**
	 * closes the currently open entry and cleans up <br>
	 * this is necessary before accessing a different entry
	 *
	 */
	...
	public static void main(String[] args) {
		...
		while (e.hasMoreElements()) {
			...
			if (sa[0].equals("nuclei")) {
				// println("ZipNuclei.main: finds: " + sa[1] + CS + ze.isDirectory() + CS +
				// zn.parseZipEntryName(sa[1]));
