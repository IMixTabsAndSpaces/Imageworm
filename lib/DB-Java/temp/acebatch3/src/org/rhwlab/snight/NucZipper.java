...
/**
 * takes the current contents of the NucleiMgr and prepares a zip file with a
 * structure like the nuclei portion of a normal input file <br>
 * this can be called following an edit
 * 
 * @author biowolp
