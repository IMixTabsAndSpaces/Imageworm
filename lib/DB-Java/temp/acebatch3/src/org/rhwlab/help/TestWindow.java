	...
	private void setKeyboardActions() {
		...
		Action home = new AbstractAction() {
			public void actionPerformed(ActionEvent e) {
				 ...
				 * KeyboardFocusManager.getCurrentKeyboardFocusManager().getFocusOwner(); Window
				 * windowFocusOwner =
				 * KeyboardFocusManager.getCurrentKeyboardFocusManager().getFocusedWindow(); if
				 * (compFocusOwner instanceof JButton) { println("its a button");
				 * ((JButton)compFocusOwner).doClick(); } println("setKeyboardActions, " +
				 * compFocusOwner);
				 */
			}
		};
